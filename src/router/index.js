  ...
  routes: [
    { path: '/', redirect: '/dashboard' },
    {
      ...
      children: [
        ...
        {
          path: 'pedidos/listar',
          component: () => import('../pages/pedidos/listar.vue'),
          beforeEnter: authMiddleware,
        },
        {
          path: 'pedidos/listar',
        ...
        {
          path: 'pedidos/ver/:id',
          component: () => import('../pages/pedidos/ver/_id.vue'),
          beforeEnter: authMiddleware,
        },
        // {
...

        {
          ...
          component: () => import('../pages/produtos/listar.vue'),
          beforeEnter: authMiddleware,
        },
        {
          path: 'produtos/cadastro',
          component: () => import('../pages/produtos/cadastro.vue'),
          beforeEnter: authMiddleware,
        },
        {
          path: 'produtos/edicao/:id',
          component: () => import('../pages/produtos/edicao/_id.vue'),
          beforeEnter: authMiddleware,
        },
        {
