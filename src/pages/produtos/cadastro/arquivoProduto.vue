<template>
  <div>
    ...
    <VRow>
      <VCol cols="12">
        <VCard title="Arquivos do Produto">
...
<script setup>
import ModalRemoverImagem from "@/components/produto/modalRemoverImagem.vue";
...
const removeImage = (index, item = null) => {
  if (item.startsWith("https")) {
    produto.modalExcluirImagem = true;
    imagem.value = formatImagemEnvio(item);
    if (produto.imagemRemovida) {
